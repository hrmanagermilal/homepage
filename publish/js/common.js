(function () {
  ...
  "head.html": [
    ...
    "            <li><a class=\"site-header__gnb-sub-item\" href=\"#\">영유아부</a></li>",
    "          </ul>",
    "        </li>",
    "        <li class=\"site-header__gnb-item-wrap\">",
    ...
    "            <li><a class=\"site-header__gnb-sub-item\" href=\"{{subRoot}}04-obituary.html\">부고</a></li>",
    "          </ul>",
    "        </li>",
    "        <li class=\"site-header__gnb-item-wrap\">",
    ...
    "      <a class=\"site-header__news-btn\" href=\"https://milalbookcafe.com/\">",
    ...
    "            <li><a class=\"full-menu__gnb-sub-link\" href=\"#\">영유아부</a></li>",
    "          </ul>",
    "          <ul class=\"full-menu__gnb-sub\">",
    ...
    "            <li><a class=\"full-menu__gnb-sub-link\" href=\"{{subRoot}}04-obituary.html\">부고</a></li>",
    "          </ul>",
    "          <!-- 05 온라인 헌금: 2차 메뉴 없음 -->",
    "        </nav>",
  ...
  "footer.html": [
    ...
    "    </li>",
    "    <li>",
    "      <a class=\"quick-menu__btn\" href=\"https://youtube.com/@milalchurch?si=xbmgxeIMCL6XbyAv\" target=\"_blank\" aria-label=\"온라인 예배 바로가기\">",
