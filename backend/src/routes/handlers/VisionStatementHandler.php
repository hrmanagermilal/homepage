...
class VisionStatementHandler {
    ...
    public function handle($id, $action) {
        try {
            $controller = new \MillalHomepage\Controllers\VisionStatementController();
            ...
            echo ResponseFormatter::error('NOT_FOUND', 'Vision statement endpoint not found', null, 404);
        } catch (\Exception $e) {
            error_log("Error in VisionStatementHandler: " . $e->getMessage());
