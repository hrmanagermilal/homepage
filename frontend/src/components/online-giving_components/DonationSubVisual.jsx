export default function DonationSubVisual() {
  return (
    <section className="sub-visual" aria-label="온라인 헌금 서브 비주얼">
      <div className="sub-visual__bg" aria-hidden="true">
        <figure className="sub-visual__bg-img donation-bg" />
      </div>
      ...
      <div className="sub-visual__cont">
        <nav className="sub-visual__lnb" aria-label="현재 위치">
          ...
          <span className="sub-visual__lnb-text">온라인 헌금</span>
        </nav>
        <h2 className="sub-visual__title">온라인 헌금</h2>
      </div>
