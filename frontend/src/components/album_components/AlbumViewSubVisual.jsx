export default function AlbumViewSubVisual() {
  return (
    <section className="sub-visual" aria-label="앨범 상세 서브 비주얼">
      <div className="sub-visual__bg" aria-hidden="true">
        <figure className="sub-visual__bg-img album-bg" />
      </div>
      ...
      <div className="sub-visual__cont">
        ...
        <h2 className="sub-visual__title">앨범</h2>
      </div>
