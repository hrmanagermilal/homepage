...
const NEXTGEN_LNB_ITEMS = [
  ...
  { label: "조이 유치부", key: "kindergarten", href: "/nextgen#kindergarten" },
  { label: "미라클 영유아부", key: "infants", href: "/nextgen#infants" },
];
...
const DEPARTMENT_CONTENT = {
  "청년부": {
    ...
    kakaoLink: "https://www.instagram.com/toronto_milight/?hl=ko",
    kakaoLabel: "청년부 인스타그램 바로가기",
    photoAlt: "신효성 목사 사진",
    noticeTitle: "청년부 소식",
  ...
  "헤세드 청소년부(KM)": {
    headingTitle: "헤세드 청소년부(KM), 믿음 안에서 함께 성장합니다.",
    ...
    kakaoLink: "https://www.instagram.com/milal.hesed/",
    kakaoLabel: "헤세드 청소년부(KM) 인스타그램 바로가기",
    photoAlt: "헤세드 청소년부(KM) 담당 교역자",
    noticeTitle: "헤세드 청소년부(KM) 소식",
  ...
  "오하나 청소년부(EM)": {
    ...
    kakaoLink: "https://www.instagram.com/milalohana/",
    kakaoLabel: "오하나 청소년부(EM) 인스타그램 바로가기",
    photoAlt: "오하나 청소년부(EM) 담당 교역자",
  },
  "카리스 아동부": {
    headingTitle: "카리스 아동부, 예수님을 닮아가는 어린이들",
    headingSub: "예배와 말씀, 활동을 통해 아이들이 즐겁게 하나님을 알아가도록 세웁니다.",
    worshipTime: "주일 오전 11시",
    worshipLocation: "밀알교회 아동부실",
    pastorName: "김진아 전도사",
    pastorEmail: "nextgen@milalchurch.com",
    noticeTitle: "카리스 아동부 프로그램",
    ...
    kakaoLabel: "카리스 아동부 카카오톡 채널 추가하기",
    photoAlt: "카리스 아동부 담당 교역자",
  },
  "조이 유치부": {
    headingTitle: "조이 유치부, 믿음의 씨앗을 심는 시간",
    headingSub: "아이들의 눈높이에 맞춘 예배와 활동으로 하나님의 사랑을 자연스럽게 배우게 합니다.",
    worshipTime: "주일 오전 11시",
    worshipLocation: "밀알교회 유치부실",
    pastorName: "김비치 전도사",
    pastorEmail: "nextgen@milalchurch.com",
    noticeTitle: "조이 유치부 프로그램",
    noticeDescription: "월간 공지사항과 부모교육 자료를 다운로드하세요.",
    noticeButtonLabel: "자료 다운로드",
    noticeButtonHref: "#",
    pastorPhoto: "/images/sub/01-introduction/minister-12.jpg",
    kakaoLink: "https://pf.kakao.com/_xdqzRK",
    kakaoLabel: "조이 유치부 카카오톡 채널 추가하기",
    photoAlt: "조이 유치부 담당 교역자",
  },
  "미라클 영유아부": {
    headingTitle: "미라클 영유아부, 사랑 안에서 첫 걸음을",
    headingSub: "부모와 교사가 함께 아이들의 신앙 첫 걸음을 따뜻하게 동행합니다.",
    worshipTime: "주일 오전 11시",
    worshipLocation: "밀알교회 영유아부실",
    pastorName: "주은지 전도사",
    pastorEmail: "nextgen@milalchurch.com",
    noticeTitle: "미라클 영유아부 프로그램",
    noticeDescription: "월간 프로그램과 부모 양육 안내자료를 다운로드하세요.",
    noticeButtonLabel: "자료 다운로드",
    noticeButtonHref: "#",
    pastorPhoto: "/images/sub/01-introduction/minister-14.jpg",
    kakaoLink: "https://pf.kakao.com/_xdqzRK",
    kakaoLabel: "미라클 영유아부 카카오톡 채널 추가하기",
    photoAlt: "미라클 영유아부 담당 교역자",
  },
};

const SUBTITLE_BY_TITLE = {
  "청년부": "Milight, Time to Shine.",
  "헤세드 청소년부(KM)": "믿음 안에서 함께 성장합니다.",
  "오하나 청소년부(EM)": "Grounded in the Word.",
  "카리스 아동부": "예수님을 닮아가는 어린이들",
  "조이 유치부": "믿음의 씨앗을 심는 시간",
  "미라클 영유아부": "사랑 안에서 첫 걸음을",
};
...
function SubVisual({ title, image }) {
  ...
  const isKindergarten = title === "조이 유치부";
