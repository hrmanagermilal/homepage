...
export default function FooterTop({ bannerImage = null, section = null }) {
  return (
    <section className="main-banner">
      <div className="main-banner__bg" aria-hidden="true">
        <img className="main-banner__bg-img" src={bannerImage?.image_url || "/images/main/banner-bg.png"} alt={bannerImage?.alt_text || ""} />
      ...
      <div className="wrap main-banner__cont" data-ani="top">
        <h2 data-heading="5xl" className="main-banner__heading">{section?.title || "교회같은 가정, 가정같은 교회"}</h2>
        <p className="main-banner__sub">
          {section?.subtitle || '교회같은 가정, 가정같은 교회를 꿈꾸며 하늘의 복을 받아 \n 세상의 복을 나누는 교회가 되길 꿈꾸는 교회입니다.'}
        </p>
