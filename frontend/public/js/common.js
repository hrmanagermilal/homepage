(function () {
  ...
  "head.html": [
    ...
    "            <li><a class=\"site-header__gnb-sub-item\" href=\"{{subRoot}}01-introduction.html#introduction02\">담임목사</a></li>",
    "            <li><a class=\"site-header__gnb-sub-item\" href=\"{{subRoot}}01-introduction.html#introduction03\">섬기는 분들</a></li>",
    ...
    "          <ul class=\"site-header__gnb-sub\">",
    "            <li><a class=\"site-header__gnb-sub-item\" href=\"{{subRoot}}02-next-generation.html\">밀라이트 청년부</a></li>",
    "            <li><a class=\"site-header__gnb-sub-item\" href=\"#\">헤세드 청소년부(KM)</a></li>",
    "            <li><a class=\"site-header__gnb-sub-item\" href=\"#\">오하나 청소년부(EM)</a></li>",
    "            <li><a class=\"site-header__gnb-sub-item\" href=\"#\">카리스 아동부</a></li>",
    "            <li><a class=\"site-header__gnb-sub-item\" href=\"#\">조이 유치부</a></li>",
    "            <li><a class=\"site-header__gnb-sub-item\" href=\"#\">미라클 영유아부</a></li>",
    "          </ul>",
    "        </li>",
    "        <li class=\"site-header__gnb-item-wrap\">",
    ...
    "          </ul>",
    "          <ul class=\"full-menu__gnb-sub\">",
    "            <li><a class=\"full-menu__gnb-sub-link\" href=\"{{subRoot}}02-next-generation.html\">밀라이트 청년부</a></li>",
    "            <li><a class=\"full-menu__gnb-sub-link\" href=\"#\">헤세드 청소년부(KM)</a></li>",
    "            <li><a class=\"full-menu__gnb-sub-link\" href=\"#\">오하나 청소년부(EM)</a></li>",
    "            <li><a class=\"full-menu__gnb-sub-link\" href=\"#\">카리스 아동부</a></li>",
    "            <li><a class=\"full-menu__gnb-sub-link\" href=\"#\">조이 유치부</a></li>",
    "            <li><a class=\"full-menu__gnb-sub-link\" href=\"#\">미라클 영유아부</a></li>",
    "          </ul>",
    "          <ul class=\"full-menu__gnb-sub\">",
    ...
    "              <span class=\"full-menu__shortcut-label\">예배 영상 보러가기</span>",
    "            </a></li>",
  ...
  function initLnb() {
    document.querySelectorAll('[data-lnb]').forEach(function (wrap) {
      ...
      if (!nav || nav.dataset.lnbReady === 'true') return;
      ...
      gnbWraps.some(function (item) {
        var title = item.querySelector('.site-header__gnb-item');
        if (title && menu && title.textContent.trim() === menu) {
          current = item;
          return true;
        }
        return false;
      ...
      nav.setAttribute('aria-label', (menu || '서브') + ' 메뉴');
      nav.innerHTML = '';
