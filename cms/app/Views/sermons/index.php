      ...
      <table>
        ...
        <tbody id="cat-tbody">
          ...
          <tr data-id="<?= $cat['id'] ?>">
            <td>
              <?php if($cat['image']): ?>
              <img src="<?= BASE_URL.htmlspecialchars($cat['image']) ?>" style="width:56px;height:40px;object-fit:cover;border-radius:4px" onerror="this.style.display='none'" alt="">
              <?php else: ?>
