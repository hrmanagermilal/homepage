...
<?php $canEdit=hasPerm('news.edit'); $canDelete=hasPerm('news.delete'); ?>
...
<div class="card">
  ...
  <div class="card-body">
    <?php if($news['image']): ?>
    <img src="<?= BASE_URL.htmlspecialchars($news['image']) ?>" style="max-width:100%;border-radius:8px;margin-bottom:16px" alt="">
    <?php endif; ?>
...
<div class="modal-overlay hidden" id="news-modal">
  <div class="modal modal-lg">
    ...
    <div class="modal-body">
      ...
      <div class="form-row">
        <div class="form-group"><label class="form-label">이미지 교체</label><input type="file" id="n-img" class="form-control" accept="image/*"><?php if($news['image']): ?><div style="margin-top:6px"><img src="<?= BASE_URL.htmlspecialchars($news['image']) ?>" style="max-height:60px;border-radius:4px"></div><?php endif; ?></div>
