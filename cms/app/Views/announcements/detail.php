...
<div class="card">
  ...
  <div class="card-body">
    ...
    <img src="<?= BASE_URL.htmlspecialchars($announcement['image']) ?>" class="detail-img" alt="">
    <?php endif; ?>
...
<div class="modal-overlay hidden" id="ann-modal">
  <div class="modal modal-lg">
    ...
    <div class="modal-body">
      ...
      <div class="form-row">
        <div class="form-group"><label class="form-label">이미지 교체</label><input type="file" id="ann-img" class="form-control" accept="image/*"><?php if($announcement['image']): ?><div style="margin-top:6px"><img src="<?= BASE_URL.htmlspecialchars($announcement['image']) ?>" style="max-height:60px;border-radius:4px"></div><?php endif; ?></div>
