  ...
  <div class="card-body" style="padding:0">
    <div class="table-wrap"><table>
      ...
      <tr data-id="<?= $r['id'] ?>">
        ...
        <td><?php if($r['image']): ?><img src="<?= BASE_URL.htmlspecialchars($r['image']) ?>" class="img-thumb" alt=""><?php else: ?><span class="text-muted">-</span><?php endif; ?></td>
        <td>
...
async function openEdit(id){
  ...
  document.getElementById('ann-img-preview').innerHTML=r.image?`<img src="${BASE_URL+r.image}" style="max-height:80px;border-radius:4px">`:'';;
  openModal('ann-modal');
}
