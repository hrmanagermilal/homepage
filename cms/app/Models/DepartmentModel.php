...
class DepartmentModel extends BaseModel {
    ...
    public function create(array $d): string {
        return $this->insert(
            'INSERT INTO departments(department_type,name,description,image,age_group,ministry_type,worship_day,worship_time,worship_location,clergy_name,clergy_position,clergy_phone,heading_title,pastor_email,kakao_link,kakao_label,notice_title,notice_description,notice_button_label,notice_button_href,`order`,is_active) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)',
            [$d['department_type']??'ministry',$d['name'],$d['description']??null,$d['image']??null,
