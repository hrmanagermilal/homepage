    ...
    public function create(array $d): string {
        return $this->insert(
            'INSERT INTO ministry(`key`,name,subtitle,title,image,description,points,
             notice_title,notice_description,notice_button_label,notice_button_href,notice_button_type,notice_button_external,
            ...
            [$d['key'], $d['name'], $d['subtitle']??null, $d['title']??null, $d['image']??null,
             ...
             $d['notice_button_href']??null, $d['notice_button_type']??'url', $d['notice_button_external']??0,
