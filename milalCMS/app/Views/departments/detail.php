  ...
  <div style="width:360px;flex-shrink:0;display:flex;flex-direction:column;gap:20px">
    ...
    <div class="card">
      ...
      <div class="card-body p-0">
        <img src="<?= UPLOAD_URL.htmlspecialchars($dept['image']) ?>" alt="<?= htmlspecialchars($dept['name']) ?>" style="width:100%;display:block;border-radius:0 0 8px 8px;max-height:200px;object-fit:cover;">
      </div>
    </div>
    <?php endif; ?>
...
<div id="dept-edit-modal" class="modal-overlay hidden">
  <div class="modal" style="max-width:780px;max-height:90vh;overflow-y:auto">
    ...
    <div class="modal-body">
      ...
      <div class="form-group"><label class="form-label">대표 이미지 (최대 1MB)</label>
        <div class="img-preview-row">
          <div class="img-thumb-box">
            <img id="em-img-preview" src="<?= ($dept['image']??'') ? UPLOAD_URL.htmlspecialchars($dept['image']) : '' ?>" style="<?= ($dept['image']??'')?'':'display:none' ?>;max-height:80px;object-fit:contain;border-radius:4px;">
      ...
      <div class="form-grid-2">
        <div class="form-group"><label class="form-label">카카오 링크</label><input class="form-control" id="em-kakao-link" value="<?= htmlspecialchars($dept['kakao_link']??'') ?>"></div>
        <div class="form-group"><label class="form-label">카카오 버튼 텍스트</label><input class="form-control" id="em-kakao-label" value="<?= htmlspecialchars($dept['kakao_label']??'') ?>"></div>
      </div>
